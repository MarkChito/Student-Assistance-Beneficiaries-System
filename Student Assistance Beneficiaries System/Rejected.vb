Public Class Rejected
    Private Sub listview_data_SizeChanged(sender As Object, e As EventArgs) Handles listview_data.SizeChanged
        ...
        listview_data.Columns(3).Width = listview_width * 0.32
        listview_data.Columns(4).Width = listview_width * 0.2
        listview_data.Columns(5).Width = listview_width * 0.15
        listview_data.Columns(6).Width = listview_width * 0.33
    End Sub
    ...
    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles Panel3.Click, Panel2.Click, Panel1.Click, Label4.Click, Label1.Click, listview_data.Click, Panel4.Click, Label2.Click, txt_search.Click
        With Main
    ...
    Private Sub Label1_MouseEnter(sender As Object, e As EventArgs) Handles Panel3.MouseEnter, Panel2.MouseEnter, Panel1.MouseEnter, Label4.MouseEnter, Label3.MouseEnter, Label1.MouseEnter, listview_data.MouseEnter, Panel4.MouseEnter, Label2.MouseEnter, txt_search.MouseEnter
        With Main

Public Class Scan_QR_Code
    ...
    Private Sub pnl_body_SizeChanged(sender As Object, e As EventArgs) Handles pnl_body.SizeChanged
        Center_Object(pnl_body, lbl_no_available_data)
    End Sub

    Private Sub Panel1_MouseEnter(sender As Object, e As EventArgs) Handles Panel3.MouseEnter, Panel2.MouseEnter, Panel1.MouseEnter, btn_scan_qr_code.MouseEnter, Panel4.MouseEnter, Label1.MouseEnter, pnl_body.MouseEnter, lbl_no_available_data.MouseEnter
        With Main
    ...
    Private Sub Panel3_Click(sender As Object, e As EventArgs) Handles Panel3.Click, Panel2.Click, Panel1.Click, btn_scan_qr_code.Click, Label1.Click, pnl_body.Click, lbl_no_available_data.Click
        With Main

Public Class Approved
    ...
    Private Sub Panel1_Click(sender As Object, e As EventArgs) Handles Panel3.Click, Panel2.Click, Panel1.Click, Label4.Click, Label1.Click, listview_data.Click, Panel4.Click, Label2.Click, txt_search.Click
        With Main
    ...
    Private Sub Panel1_MouseEnter(sender As Object, e As EventArgs) Handles Panel3.MouseEnter, Panel2.MouseEnter, Panel1.MouseEnter, Label4.MouseEnter, Label3.MouseEnter, Label1.MouseEnter, listview_data.MouseEnter, Panel4.MouseEnter, Label2.MouseEnter, txt_search.MouseEnter
        With Main
